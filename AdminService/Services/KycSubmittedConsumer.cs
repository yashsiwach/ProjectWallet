...
public class KycSubmittedConsumer : BackgroundService
{
    ...
    public KycSubmittedConsumer(IServiceScopeFactory scopeFactory,IConfiguration config,ILogger<KycSubmittedConsumer> logger)
    {
            ...
            consumer.Received += async (sender, ea) =>
            {
                try
                {
                    ...
                    if (payload != null)
                    {
                        ...
                        var adminService = scope.ServiceProvider.GetRequiredService<AdminServices>();
                ...
                {
                    _logger.LogError("Error processing KYC event: {Message}",
                        ex.Message);
