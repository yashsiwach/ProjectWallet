...
public class NotificationRepository : INotificationRepository
{
    ...
    public NotificationRepository(IConfiguration config, ILogger<NotificationRepository> logger)
    {
        ...
        var indexKey = Builders<Notification>.IndexKeys
    ...
    public Task<List<Notification>> GetByUserIdAsync(string userId, int page, int pageSize) =>
    ...
    public Task<long> CountByUserIdAsync(string userId) =>
        _collection.CountDocumentsAsync(n => n.UserId == userId);

    public Task<long> CountUnreadAsync(string userId) =>
        _collection.CountDocumentsAsync(n => n.UserId == userId && !n.IsRead);
